...
public class HiberConfiguration {
    ...
    public static String buildDatabaseUrl(ApplicationConfigReader inputConfigReader) {
        ...
        if (dbAddress.startsWith(DOT)) {
            ...
            dbAddress = Paths.get(databaseDir.getAbsolutePath(), dbAddress.substring(2)).toString();
        }
