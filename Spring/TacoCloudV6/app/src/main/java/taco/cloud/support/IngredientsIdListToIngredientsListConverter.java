...
@Component
public class IngredientsIdListToIngredientsListConverter implements Converter<List<String>, List<Ingredient>> {
    ...
    @Override
    public List<Ingredient> convert(List<String> idList) {
